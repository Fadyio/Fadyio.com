...
date: "2022-10-20"
tags: ["AWS", "EKS"]
description: "Improve the reliability and security of Amazon EKS workloads with practical guidance for resources, capabilities, storage, and availability zones."
image: "./images/EKS-best-practices-you-should-know.webp"
---

In this article, we’ll explore several Amazon EKS best practices and learn how to validate workloads against them.

## 1. Configure resource requests and limits intentionally

Pods are scheduled based on their resource requests, not their limits. A pod is placed on a node only when the node's available capacity can meet those requests. Limits are not considered during scheduling, but they help prevent one pod from consuming all of a node's resources because of an error or bug.
